				...
				<?php else: ?>
					<?php foreach($perdetails as $perdetails): ?>
						<?php foreach($std as $std): ?>
							...
							<div class="col-md-12 col-xs-12">
								...
								<div class="col-md-4 col-xs-4">
									...
									<?php if ($std->semester == "First Semester"): ?>
										<li class="agileits-main"><input value="Second Semester" type="text"  readonly></li>
									<?php endif; ?>
									<?php if ($std->semester == "Second Semester"): ?>
										<li class="agileits-main"><input value="Third Semester" type="text"  readonly></li>
									<?php endif; ?>
									<?php if ($std->semester == "Third Semester"): ?>
										<li class="agileits-main"><input value="Forth Semester" type="text"  readonly></li>
									<?php endif; ?>
									<?php if ($std->semester == "Forth Semester"): ?>
										<li class="agileits-main"><input value="Fifth Semester" type="text"  readonly></li>
									<?php endif; ?>
									<?php if ($std->semester == "Fifth Semester"): ?>
										<li class="agileits-main"><input value="Sixth Semester" type="text"  readonly></li>
									<?php endif; ?>
									<?php if ($std->semester == "Sixth Semester"): ?>
										<li class="agileits-main"><input value="Seventh Semester" type="text"  readonly></li>
									<?php endif; ?>
									<?php if ($std->semester == "Seventh Semester"): ?>
										<li class="agileits-main"><input value="Eighth Semester" type="text"  readonly></li>
									<?php endif; ?>
									<?php if ($std->semester == "Eighth Semester"): ?>
						...
						<div class="text-right container">
							<a href="<?php echo base_url("student/semregistration2"); ?>">
