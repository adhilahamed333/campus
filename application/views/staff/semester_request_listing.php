        ...
        <table border='1'>
          ...
          ?>
            <tr>
              ...
              <td><a href="<?php echo base_url("staff/personalprofile/") . $post->admission_no; ?>">Personal details</a><br><a href="<?php echo base_url("staff/acdprofile/") . $post->admission_no; ?>">Academic details</a></td>
