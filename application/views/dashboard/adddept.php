    ...
    <form action="deptreg" method="POST">
      <div class="form-row">
        <div class="form-group col-md-6">
          ...
          <input type="text" class="form-control" name="department" placeholder="Enter the department name">
        </div>
        <div class="form-group col-md-6">
          <label>Department ID</label>
          <input type="text" class="form-control" name="department_id" placeholder="Enter Department Id">
        </div>
      </div>
      <div class="form-row">
        <div class="form-group col-md-6">
          <label>Staff-In-Charge</label>
          <input type="text" class="form-control" name="staffincharge" placeholder="Name of Staff in charge">
        </div>
        <div class="form-group col-md-6">
